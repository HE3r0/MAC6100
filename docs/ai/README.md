...
Human docs live one level up: README, BUILDING, DEVELOPMENT, ARCHITECTURE, CHANGELOG, ROADMAP.

TTD (task/technical docs): [../ttd/](../ttd/) — szczegółowe notatki z sesji, żeby nie ginął kontekst.
